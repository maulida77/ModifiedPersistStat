...
#%%
path_data = "BatikNitik960/data/000/"
path_diag = "BatikNitik960/pdiagrams/"
path_results = "results/"
data_name =   "batiknitik960" 
...
train_labels = np.array(pd.read_csv(path_data + "train.txt", sep=" ", 
                                    usecols=[0]).to_numpy().flatten().tolist()) #modif col 0 for batik, 1 for outex
...
if number_labels==10:
    ...
    label_list = train_labels[train_index] # -->modif for batik
else:
